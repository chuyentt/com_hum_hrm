 ...
 */
class Humg_hrmViewDepartments extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        Humg_hrmHelper::addSubmenu('departments');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_HUMG_HRM_TITLE_DEPARTMENTS'), 'departments.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_humg_hrm&view=departments');
        ...
        $form = JForm::getInstance('com_humg_hrm.department', 'department');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_HUMG_HRM_DEPARTMENTS_TITLE'),
		'a.department_guid' => JText::_('COM_HUMG_HRM_DEPARTMENTS_DEPARTMENT_GUID'),
		);
	}
