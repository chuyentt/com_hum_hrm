...
class Humg_hrmViewPositions extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        Humg_hrmHelper::addSubmenu('positions');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_HUMG_HRM_TITLE_POSITIONS'), 'positions.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_humg_hrm&view=positions');
        ...
        $form = JForm::getInstance('com_humg_hrm.position', 'position');
	...
	protected function getSortFields()
	{
		...
		'a.employee_guid' => JText::_('COM_HUMG_HRM_POSITIONS_EMPLOYEE_GUID'),
		'a.position_guid' => JText::_('COM_HUMG_HRM_POSITIONS_POSITION_GUID'),
		'a.department_guid' => JText::_('COM_HUMG_HRM_POSITIONS_DEPARTMENT_GUID'),
		'a.start' => JText::_('COM_HUMG_HRM_POSITIONS_START'),
		'a.end' => JText::_('COM_HUMG_HRM_POSITIONS_END'),
		);
	}
