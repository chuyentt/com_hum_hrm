 ...
 */
class Humg_hrmModelDepartments extends JModelList
{
...
if (empty($list['direction']))
{
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__humg_hrm_department` AS a');
    ...
    $query->join('LEFT', '#__users AS uc ON uc.id=a.checked_out');
		...
		$query->select('#__humg_hrm_department_1733792.title AS department_title');
		$query->join('LEFT', '#__humg_hrm_department AS #__humg_hrm_department_1733792 ON #__humg_hrm_department_1733792.guid = a.department_guid');

		
if (!JFactory::getUser()->authorise('core.edit.state', 'com_humg_hrm'))
{
