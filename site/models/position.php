 ...
 * Humg_hrm model.
 */
class Humg_hrmModelPosition extends JModelItem {
    ...
    public function &getData($id = null) {
		...
		if ( isset($this->_item->created_by) ) {
			...
			if (isset($this->_item->position_guid) && $this->_item->position_guid != '') {
				if(is_object($this->_item->position_guid)){
					$this->_item->position_guid = JArrayHelper::fromObject($this->_item->position_guid);
				}
				$values = (is_array($this->_item->position_guid)) ? $this->_item->position_guid : explode(',',$this->_item->position_guid);
			...
			$this->_item->position_guid = !empty($textValue) ? implode(', ', $textValue) : $this->_item->position_guid;
