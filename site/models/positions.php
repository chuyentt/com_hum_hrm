...
if (empty($list['direction']))
{
    ...
    $query->join('LEFT', '#__users AS uc ON uc.id=a.checked_out');
		...
		$query->select('#__humg_hrm_employee_1733797.fullname AS employee_fullname');
		...
		$query->select('#__humg_hrm_positiontype_1733780.title AS positiontype_title');
		...
		$query->select('#__humg_hrm_department_1733795.title AS department_title');
