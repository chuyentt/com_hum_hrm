...
<div class="contact-edit front-end-edit">
    ...
    <form id="form-contact" action="<?php echo JRoute::_('index.php?option=com_humg_hrm&task=contact.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<div class="control-group">
        ...
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_humg_hrm&task=contactform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
